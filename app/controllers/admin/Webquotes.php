...
class WebQuotes extends MY_Controller {
    ...
    public function __construct() {
        ...
        $this->load->admin_model('WebQuotes_model', 'quotes_model');
    ...
    public function getQuotes($warehouse_id = null) {
        ...
        $detail_link = anchor('admin/webquotes/view/$1', '<i class="fa fa-file-text-o"></i> ' . lang('quote_details'));
        $email_link = anchor('admin/webquotes/email/$1', '<i class="fa fa-envelope"></i> ' . lang('email_quote'), 'data-toggle="modal" data-target="#myModal"');
        $edit_link = anchor('admin/webquotes/edit/$1', '<i class="fa fa-edit"></i> ' . lang('edit_quote'));
    ...
    public function import() {
        ...
        if ($this->form_validation->run() == true && $this->quotes_model->addQuote($data, $products)) {
            ...
            $this->page_construct('webquotes/import_csv', $meta, $this->data);
        }
    }
