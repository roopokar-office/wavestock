                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang("Tag", "tag") ?>
                                <?php
                                $tg[''] = lang('select').' '.lang('Tag');
                                foreach ($tags as $tag) {
                                    $tg[$tag->id] = $tag->name;
                                }
                                echo form_dropdown('tag', $tg, (isset($_POST['tag']) ? $_POST['tag'] : ''), 'class="form-control select" id="tag" placeholder="' . lang("select") . " " . lang("tag") . '" style="width:100%"')
                                ?>
                            </div>
                        </div>
