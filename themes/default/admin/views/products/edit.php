                    ...
                    <div class="form-group standard">
                        ...
                        <?php
                            ...
                            foreach ($selected_tags as $selected_tag){
                                array_push($tag_ids, $selected_tag->tag_id);
                            }
//                            echo "<pre>";
//                            print_r($tag_ids);
//                            echo "</pre>";
                        ...
                        <?php foreach ($tags as $tag): ?>
                            <input name="tags[]" type="checkbox" class="checkbox" id="tags-<?=$tag->id?>" value="<?=$tag->id?>" <?= (in_array($tag->id, $tag_ids)) ? 'checked="checked"' : '' ?>/>
