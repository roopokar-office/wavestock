...
<div class="box">
    <div class="box-header no-print">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('print_barcode_label') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')'; ?></h2>
                ...
                <?php if (!empty($warehouses)) {
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?=admin_url('products/print_barcodes_warehouse')?>"><i class="fa fa-building-o"></i> <?=lang('all_warehouses')?></a></li>
                            <li class="divider"></li>
                            <?php
                            foreach ($warehouses as $warehouse) {
                                echo '<li><a href="' . admin_url('products/print_barcodes_warehouse/' . $warehouse->id) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                            }
                            ?>
                        </ul>
                    </li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="well well-sm no-print">
                    <?= admin_form_open("products/print_barcodes_warehouse/$warehouse_id", 'id="barcode-print-form" data-toggle="validator"'); ?>
                    ...
                    <?php
                        if ($this->input->post('print')) {
                            if (!empty($barcodes)) {
                                ...
                                echo '<h3>'.lang('no_product_found').'</h3>';
                            }
                        }
                    ?>
                </div>
