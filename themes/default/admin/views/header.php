                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_products">
                                ...
                                <ul>
                                    ...
                                    <li id="products_index">
                                        <a class="submenu" href="<?= admin_url('products/product_list_filter'); ?>">
                                            <i class="fa fa-barcode"></i>
                                            <span class="text"> <?= lang('List_Products_with_Filter'); ?></span>
                                        </a>
                                    </li>
                                    <li id="products_add">
                            ...
                            <li class="mm_quotes">
                                <a class="dropmenu" href="#">
                                    ...
                                    <span class="text"> <?= lang('Quotation'); ?> </span>
                                    <span class="chevron closed"></span>
                                </a>
                                <ul>
                                    <li id="quotes_index">
                                        <a class="submenu" href="<?= admin_url('quotes'); ?>">
                                            <i class="fa fa-heart-o"></i>
                                            <span class="text"> <?= lang('List_Quotations'); ?></span>
                                        </a>
                                    </li>
                                    <li id="quotes_add">
                                        <a class="submenu" href="<?= admin_url('quotes/add'); ?>">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('Add_Quotation'); ?></span>
                                        </a>
                                    </li>
                                    <?php /* ?>
                                    <li id="web_quotes_import">
                                        <a class="submenu" href="<?= admin_url('webquotes/import'); ?>">
                                            <i class="fa fa-file-text"></i>
                                            <span class="text"> <?= lang('Import Quotations'); ?></span>
                                        </a>
                                    </li>
                                    <?php */ ?>
                                    <li id="web_quotes_index">
                                        <a class="submenu" href="<?= admin_url('webquotes'); ?>">
                                            <i class="fa fa-heart-o"></i>
                            ...
                            <li class="mm_reports">
                                ...
                                <ul>
                                    ...
                                    <li id="reports_expiry_alerts">
                                        <a href="<?= admin_url('reports/expiry_alerts_lot') ?>">
                                            <i class="fa fa-bar-chart-o"></i><span class="text"> <?= lang('product_expiry_alerts_lot'); ?></span>
                                        </a>
                                    </li>
                                    <?php } ?>
