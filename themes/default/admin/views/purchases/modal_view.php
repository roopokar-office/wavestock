...
<div class="modal-dialog modal-lg no-modal-header">
    <div class="modal-content">
        <div class="modal-body">
            ...
            <button type="button" class="btn btn-xs btn-default no-print pull-right" id="table-export" data-filename="Purchase_Details" style="margin-right:15px;">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <h1 class="text-uppercase">Purchase</h1>
                </div>
            </div>
            <style>
                .bordered-box {
