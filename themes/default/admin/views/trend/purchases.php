...
<script>
    $(document).ready(function () {
        var source_url = "<?= admin_url('trend/getPurchaseReport/?v=1' . $v) ?>";
        var colNames = [null, null
            <?php foreach ($months as $month){?> ,{"mRender": formatQuantity} <?php } ?>];
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-star"></i><?= lang('Trend_Purchase_Report'); ?> <?php
            if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("trend/purchases"); ?>
                    <div class="row">
                        <div class="col-sm-4">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('trend/getPurchaseReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('trend/getPurchaseReport/0/xls/?v=1'.$v)?>";
            return false;
        });
